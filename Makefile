...
COMMON_LIBS = 			$(LIB_TIO) $(LIB_TTS) $(LIB_TS) $(LIB_TU) $(LIB_SBF) $(LIB_DBF)
LIBS = 					$(COMMON_LIBS) $(LIB_VIO) $(LIB_VS) $(LIB_VU) $(LIB_S_ANALYSIS) $(LIB_H_ANALYSIS) $(LIB_MCPU_ANALYSIS)
...
$(MCPU_ANALYSIS) : $(OBJ_MCPU_ANALYSIS) $(COMMON_LIBS) $(LIB_VIO) $(LIB_VS) $(LIB_VU) $(LIB_S_ANALYSIS) $(LIB_H_ANALYSIS) $(LIB_MCPU_ANALYSIS)
