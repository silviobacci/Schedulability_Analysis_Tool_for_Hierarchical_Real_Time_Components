...
LIBS = 					$(LIB_CIO) $(LIB_TIO) $(LIB_SP) $(LIB_UF) $(LIB_UTILITIES) $(LIB_PRINTS) $(LIB_FF) $(LIB_SBF) $(LIB_DBF_EDF) $(LIB_DBF_FP) $(LIB_S_ANALYSIS_EDF) $(LIB_S_ANALYSIS_FP) $(LIB_H_ANALYSIS_EDF) $(LIB_H_ANALYSIS_FP) $(LIB_MCPU_ANALYSIS)
